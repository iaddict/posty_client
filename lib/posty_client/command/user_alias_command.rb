...
module PostyClient
  module Command
    class UserAliasCommand < Thor
      ...
      desc "list [USER]@[DOMAIN]", "list all user_aliases of given user"
      def list(name)
      ...
      desc "add [USER]@[DOMAIN] [USER_ALIAS]", "add an user_alias"
      ...
      desc "delete [ALIAS]@[DOMAIN] [USER_ALIAS]", "delete the specified user_alias"
